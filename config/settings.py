...
SECRET_KEY =  os.environ.get('SECRET_KEY', 'django-insecure-di!v*m61r8eby_8*_uva=*75*f(k823cq4lo6zkdwaimu#e=e8')
print(SECRET_KEY)
...
AUTH_USER_MODEL = 'users.User' # Подключаем модель User
